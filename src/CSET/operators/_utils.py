...
def combine_cubes_into_cubelist(
    ...
    Arguments
    ---------
    first: iris.cube | iris.cube.CubeList
        First cube or cubelist to merge into cubelist.
    second: iris.cube | iris.cube.CubeList
        Second cube or cubelist to merge into cubelist. This must be a named argument.
    third: iris.cube | iris.cube.CubeList
    ...
    ------
    TypeError
    If the provided arguments are not either an iris.cube or iris.cube.CubeList.
    """
