...
#       # Keep valid time as auxiliary coordinate.
#         #
#         analysis_slice.add_aux_coord(time_coord, data_dims=(time_dim,))
...
#     print(fixed_analysis_cubes.concatenate())
#     print(fixed_analysis_cubes.merge())


#     try:
#         merged = fixed_analysis_cubes.merge_cube()
