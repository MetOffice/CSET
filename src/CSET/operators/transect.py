...
def calc_transect(
    ...
    input: Cube | CubeList
        An iris cube or cubelist containing latitude and longitude coordinate dimensions,
    ...
    for cube in input:
        ...
        for key, value in cube.attributes.items():
            interpolated_cubes[0].attributes.setdefault(key, value)

        output.append(interpolated_cubes[0])
