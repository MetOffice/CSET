...
STASH_TO_LFRIC = {
    ...
    "m01s00i005": ("orographic_gradient_x_component", "face"),
    "m01s00i006": ("orographic_gradient_y_component", "face"),
    "m01s00i007": ("unfiltered_orography", "face"),
    "m01s00i008": ("soil_bulk_density", "face"),
    "m01s00i010": ("specific_humidity", "face"),
    "m01s00i012": ("specific_cloud_ice", "face"),  # Overwritten below.
    "m01s00i017": ("silhouette_orographic_roughness", "face"),
    "m01s00i018": ("half_peak_to_trough_height_orography", "face"),
    ...
    "m01s00i034": ("standard_deviation_orography", "face"),
    "m01s00i035": ("orographic_gradient_xx_component", "face"),
    "m01s00i036": ("orographic_gradient_xy_component", "face"),
    "m01s00i037": ("orographic_gradient_yy_component", "face"),
    "m01s00i096": ("ocean_near_surface_chlorophyll", "face"),
    "m01s00i097": ("bare_soil_momentum_roughness_length", "face"),
    "m01s00i150": ("upward_air_velocity_at_cell_interfaces", "face"),
    "m01s00i207": ("clapp_hornberger_b_coefficient", "face"),
    "m01s00i216": ("fractions_of_surface_types", "face"),
    ...
    "m01s00i274": ("mean_topographic_index", "face"),
    "m01s00i275": ("standard_deviation_topographic_index", "face"),
    ...
    "m01s00i494": ("urban_building_height", "face"),
    "m01s00i495": ("urban_height_to_width_ratio", "face"),
    "m01s00i496": ("urban_width_ratio", "face"),
    ...
    "m01s06i248": ("orographic_subgrid_slope", "face"),
    "m01s06i249": ("orographic_subgrid_anisotropy", "face"),
    "m01s06i250": ("orographic_subgrid_orientation", "face"),
