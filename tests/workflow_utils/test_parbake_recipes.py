...
#     recipe_path = parbake.recipe_file()
...
#     actual = parbake.data_directories(case_aggregation=False)
...
#     actual = parbake.data_directories(case_aggregation=True)
#     assert actual == expected


# def test_entrypoint(monkeypatch):
#     """Check that parbake.run() calls the correct function."""
#     function_ran = False
...
#     """Check that parbake.run() exits non-zero."""
