...
diagnostics that can be quickly created by the combination of operators
in :doc:`usage/operator-recipes`. Common operations such as reading, writing,
...
:doc:`contributing/index` to ensure that they stay maintained. By
