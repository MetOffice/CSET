...
1. Add site file at ``src/CSET/cset-workflow/site/<site>.cylc``
2. Add entry to ``src/CSET/cset-workflow/meta/rose-meta.conf.jinja2``
...
create a new file at ``src/CSET/cset-workflow/site/acme.cylc`` with the following
content:
...
``src/CSET/cset-workflow/meta/rose-meta.conf.jinja2``. Within that file find the
